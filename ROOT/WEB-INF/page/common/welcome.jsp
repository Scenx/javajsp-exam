			...
			<table width="100%" border="0" class="tm_param_list">
				<tbody>
					...
					<tr>
						...
						<td>
							<a href="mailto:scen@vip.qq.com"><tomtag:Message key="txt.other.welcome.soft.contract.email" /></a>
							-
							<a href="http://www.ncwuhz.cn" target="_blank"><tomtag:Message key="txt.other.welcome.soft.contract.site" /></a>
							-
							<a href="http://www.weibo.com/u/5526406074" target="_blank"><tomtag:Message key="txt.other.welcome.soft.contract.weibo" /></a>
							-
							<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=862351901&site=qq&menu=yes"><tomtag:Message key="txt.other.welcome.soft.contract.qq" /></a>
						</td>
					</tr>
					<tr>
						<th><tomtag:Message key="txt.other.welcome.soft.use_help" /></th>
						<td>
							<a href="http://www.ncwuhz.cn" target="_blank"><tomtag:Message key="txt.other.welcome.soft.use_help.manual" /></a>
							-
							<a href="http://www.ncwuhz.cn" target="_blank"><tomtag:Message key="txt.other.welcome.soft.use_help.advice" /></a>
						</td>
					</tr>
				</tbody>
			</table>
