...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="10" class="tm_table_about">
		<tr>
			...
			<td valign="top">
				<h1>Scen网络考试系统</h1>
				<p>感谢您选择Scen产品，希望我们的努力能为您提供一个高效快速和强大的在线考试解决方案。</p>
				<p>Scen是一款基于JAVA与MYSQL开发的网络考试系统。它可以稳定、顺畅的运行在Windows与Linux平台上。您可以通过它快捷方便的创建题库，发布试卷，组织考试，由系统自动批改，并对考试结果进行数据分析。高度的可配置性和灵活性使得它可以被应用于很多领域。</p>
				<br/>
				<p>
					<div><b>版本信息</b>：<tomtag:Util action="version" /> </div>
				</p>
				<p><b>系统状态</b>：${total_users} / ${auth_users} 用户数</p>
				<p><b>版权信息</b>：Copyright ncwuhz.com 2017 All Right Reserved</p>
				<p><b>使用权限</b>：本计算机程序受到著作权法保护。未经授权而擅自修改、复制和传播本程序（或其中的任何部分），将受到严厉的民事和刑事制裁，并将在法律许可的最大限度内受到起诉。</p>
				<p><b>官网地址</b>：http://www.ncwuhz.cn</p>
				<p><b>电子信箱</b>：scen@vip.qq.com</p>
			</td>
		</tr>
	</table>
