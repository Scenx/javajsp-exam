...
<body>
    ...
    <div class="tm_head">
        ...
        <div class="tm_head_logo"><a href="http://www.ncwuhz.cn" target="_blank"><img src="skins/images/logo.png" /></a></div>
		...
		<c:if test="${sessionScope.SEN_USERTYPE == '1'}">
			...
			<div class="tm_head_tools">
				...
				<a href="http://www.ncwuhz.cn" target="_blank"><tomtag:Message key="message.other.feedback" /></a> |
