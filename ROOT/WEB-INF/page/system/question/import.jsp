...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			jQuery('#form_question_import').validationEngine();
		});
		
		function makeButtonLabel(obj){
			var formcheck = $("#form_question_import").validationEngine('validate');
			if(formcheck){
				$(obj).text('<tomtag:Message key="message.sys.question.import.ing" />');
				$(obj).attr("disabled", true);
				$('#form_question_import').submit();
				setTimeout(function(){
					$(obj).text('<tomtag:Message key="txt.other.operations.submit" />');
...
<body>
	...
	<div class="tm_main">
        ...
        <br/>
        <div class="tm_container">
			<form action="system/question/batchImport.do" method="post" enctype="multipart/form-data" id="form_question_import">
			<div class="tm_batch_help">
				<div>
					<img src="skins/images/icos/point_yellow.png" align="absmiddle" /> 
					<tomtag:Message key="txt.sys.question.import.help" />
				</div>
				<div>
					<img src="skins/images/icos/point_green.png" align="absmiddle" /> 
					<a href="files/template/template_questions.zip" target="_blank"><tomtag:Message key="txt.other.operations.gettemplate" /></a> 
        	...
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
                ...
                <tfoot>
                	<tr>
                    	<th></th>
                        <td colspan="3">
                        	<button class="tm_btn tm_btn_primary"  type="button" onclick="javascript:makeButtonLabel(this)"><tomtag:Message key="txt.other.operations.submit" /></button>
