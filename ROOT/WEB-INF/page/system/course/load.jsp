...
<body>
	...
	<div class="tm_main">
        ...
        <br/>
        <div class="tm_container">
			<form action="system/course/update.do" method="post" id="form_course_update">
							...
							<div id="tm_lessons">
								...
								<table width="900" cellpadding="0" border="0" class="tm_table_lesson">
									...
									<tr>
										...
										<td>
											<select class="tm_select" style="width:270px" name="c_lesson_filetype">
												...
												<option value="swf" <c:if test="${lesson.filetype == 'swf'}">selected</c:if>>SWF</option>
												<option value="pdf" <c:if test="${lesson.filetype == 'pdf'}">selected</c:if>>PDF</option>
											</select>
										</td>
									...
									<tr>
										...
										<td colspan="3">
											<input type="text" name="c_lesson_filepath" id="c_lesson_filepath_${lesson.id}" class="validate[required] tm_txt" size="50" maxlength="100" style="width:680px" value="${lesson.filepath}" />
