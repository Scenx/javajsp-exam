...
<head>
	...
	<title><tomtag:Message key="message.sys.news.category.add" /></title>
	...
	<div class="tm_main">
		...
		<div class="tm_container">
			<ul class="tm_breadcrumb">
				...
				<li class="active"><tomtag:Message key="message.sys.news.category.add" /></li>
			</ul>
		</div>
        
        <div class="tm_container">
        	<div class="tm_navtitle">
				<h1><tomtag:Message key="txt.sys.news.category.add" /></h1>
                <span><tomtag:Message key="txt.sys.news.category.addtip" /></span>
            </div>
			<div class="tm_navbuttons">
				<a href="system/news/category/add.thtml" class="on"><tomtag:Message key="txt.sys.news.category.add" /></a>
        ...
        <br/>
        <div class="tm_container">
			<form action="system/news/category/save.do" method="post" id="form_category_add">
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
                    <tr>
                        <th width="120"><tomtag:Message key="txt.sys.news.category.fields.name" /> : </th>
                        <td>
							<input type="text" name="c_name" class="validate[required] tm_txt" size="50" maxlength="50" />
					...
					<tr>
                        ...
                        <td>
                            <input type="text" name="c_orderid" class="validate[required,custom[integer]] tm_txt" size="5" value="1" />
							<span class="tm_required">*</span> 
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="c_remark" class="tm_txt" size="50" maxlength="50" />
                        </td>
                    </tr>
                </tbody>
