        	...
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
					...
					<tr>
                        ...
                        <td>
							<input type="text" name="n_visit" class="validate[required,custom[integer]] tm_txt" size="50" value="1" />
						</td>
                    </tr>
					<tr>
                        <th><tomtag:Message key="txt.sys.news.fields.author" /> : </th>
                        <td>
							<input type="text" name="n_author" class="tm_txt" size="50" />
						</td>
						<th><tomtag:Message key="txt.sys.news.fields.from" /> : </th>
                        <td>
							<input type="text" name="n_newsfrom" class="tm_txt" size="50" />
						</td>
                    </tr>
					<tr>
