...
<head>
	...
	<title><tomtag:Message key="txt.sys.paper.category.add" /></title>
	...
	<div class="tm_main">
		...
		<div class="tm_container">
			<ul class="tm_breadcrumb">
				...
				<li class="active"><tomtag:Message key="txt.sys.paper.category.add" /></li>
			</ul>
		</div>
        
        <div class="tm_container">
        	<div class="tm_navtitle">
				<h1><tomtag:Message key="txt.sys.paper.category.add" /></h1>
                <span><tomtag:Message key="txt.sys.paper.category.addtip" /></span>
            </div>
			<div class="tm_navbuttons">
				<a href="system/paper/category/add.thtml" class="on"><tomtag:Message key="txt.sys.paper.category.add" /></a>
				<a href="system/paper/category/list.thtml"><tomtag:Message key="txt.sys.paper.category.list" /></a>
			</div>
        </div>
        
        <br/>
        <div class="tm_container">
			<form action="system/paper/category/save.do" method="post" id="form_category_add">
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
                    <tr>
                        <th width="120"><tomtag:Message key="txt.sys.paper.category.fields.name" /> : </th>
                        <td>
							<input type="text" name="c_name" class="validate[required] tm_txt" size="50" maxlength="30" />
							<span class="tm_required">*</span> 
							<span class="tm_tip"><tomtag:Message key="txt.sys.paper.category.fields.name.tip" /></span> 
						</td>
                    </tr>
                    <tr>
                        <th><tomtag:Message key="txt.sys.paper.category.fields.status" /> : </th>
                        <td>
                            <select class="tm_select" name="c_status" style="min-width:150px">
                    ...
                    <tr>
                        <th valign="top"><tomtag:Message key="txt.sys.paper.category.fields.remark" /> : </th>
                        <td><input type="text" name="c_remark" class="tm_txt" size="50" maxlength="50" /></td>
                    </tr>
                </tbody>
