...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() { 
			jQuery('#form_user_add').validationEngine();
	...
	<div class="tm_main">
        ...
        <div class="tm_container">
        	<div class="tm_navtitle">
				<h1><tomtag:Message key="txt.sys.user.add" /></h1>
                <span><tomtag:Message key="txt.sys.user.addtip" /></span>
            </div>
			<div class="tm_navbuttons">
				<a href="system/user/add.thtml" class="on"><tomtag:Message key="txt.sys.user.add" /></a>
        ...
        <br/>
        <div class="tm_container">
			<form action="system/user/save.do" method="post" id="form_user_add">
        	<table width="100%" cellpadding="5" border="0" class="tm_table_form">
            	<tbody>
                    <tr>
                        <th width="120"><tomtag:Message key="txt.sys.user.fields.username" /> : </th>
                        <td>
							<input type="text" name="u_username" class="validate[required] tm_txt" size="50" maxlength="30" />
					...
					<tr>
                        ...
                        <td>
							<input type="password" id="u_userpass" name="u_userpass" class="validate[required] tm_txt" size="50" maxlength="30" />
							<span class="tm_required">*</span> 
							<span class="tm_tip"><tomtag:Message key="txt.sys.user.fields.userpass.tip" /></span> 
					...
					<tr>
                        ...
                        <td>
							<input type="text" name="u_realname" class="validate[required] tm_txt" size="50" maxlength="30" />
							<span class="tm_required">*</span> 
					...
					<tr>
                        ...
                        <td>
							<input type="text" name="u_score" class="validate[required,custom[number]] tm_txt" size="50" maxlength="5" value="0" />
							<span class="tm_required">*</span> 
					...
					<tr>
                        ...
                        <td>
							<input type="text" name="u_no" class="tm_txt" size="50" maxlength="30" />
							<span class="tm_tip"><tomtag:Message key="txt.sys.user.fields.no.tip" /></span>
						</td>
                    </tr>
					<tr>
                        <th><tomtag:Message key="txt.sys.user.fields.phone" /> : </th>
                        <td><input type="text" name="u_phone" class="tm_txt" size="50" maxlength="30" /></td>
                    </tr>
					<tr>
                        <th><tomtag:Message key="txt.sys.user.fields.email" /> : </th>
                        <td><input type="text" name="u_email" class="tm_txt" size="50" maxlength="30" /></td>
                    </tr>
					<tr>
                        <th><tomtag:Message key="txt.sys.user.fields.address" /> : </th>
                        <td><input type="text" name="u_address" class="tm_txt" size="50" maxlength="30" /></td>
                    </tr>
					<tr>
					...
					<tr>
                        ...
                        <td><input type="text" name="u_remark" class="tm_txt" size="50" maxlength="50" /></td>
                    </tr>
                </tbody>
